function [u]=power_referencetracking_iio(mpcmodel,Hp,Hc,Inputs,Outputs,scalingfactors,dirdmd,qq,rr)
...
set(gcf,'color','w','Position', get(0, 'Screensize'),'Visible','off');
subplot(2,1,1)
p3=plot(time(1:maxd),u(1:end)*scalingfactors(3),'LineWidth',1.6'); %1
...
subplot(2,1,2)
deltau=diff(u*scalingfactors(3));
