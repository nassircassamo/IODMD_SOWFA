/* SB03MV.f -- translated by f2c (version 20041007).
...
/* Subroutine */ int sb03mv(logical *ltran, logical *lupper, doublereal *t, 
...
/* L20: */
	...
	if (ipsv != i__) {
	    dswap(&c__3, &t9[ipsv - 1], &c__3, &t9[i__ - 1], &c__3);
	    temp = btmp[i__ - 1];
	    btmp[i__ - 1] = btmp[ipsv - 1];
	    btmp[ipsv - 1] = temp;
	}
	if (jpsv != i__) {
	    dswap(&c__3, &t9[jpsv * 3 - 3], &c__1, &t9[i__ * 3 - 3], &c__1);
	}
	jpiv[i__ - 1] = jpsv;
