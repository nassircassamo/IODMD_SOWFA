/* SB03MY.f -- translated by f2c (version 20041007).
...
/* Subroutine */ int sb03my(char *trana, integer *n, doublereal *a, integer *
...
/* Computing MAX */
    d__1 = smlnum, d__2 = eps * dlanhs("Max", n, &a[a_offset], lda, dum);
    smin = max(d__1,d__2);
...
/*           K1 (K2): row index of the first (last) row of X(K,L). */
		...
		if (l1 == l2 && k1 == k2) {
		    i__3 = k1 - 1;
		    i__4 = l1 - 1;
		    vec[0] = c__[k1 + l1 * c_dim1] - (ddot(&i__3, &a[k1 * 
			    a_dim1 + 1], &c__1, &c__[l1 * c_dim1 + 1], &c__1) 
			    + ddot(&i__4, &c__[k1 + c_dim1], ldc, &a[l1 * 
			    a_dim1 + 1], &c__1));
		    scaloc = 1.;
...
/* L10: */
			...
			*scale *= scaloc;
		    ...
		    i__3 = k1 - 1;
		    i__4 = l1 - 1;
		    vec[1] = c__[k2 + l1 * c_dim1] - (ddot(&i__3, &a[k2 * 
			    a_dim1 + 1], &c__1, &c__[l1 * c_dim1 + 1], &c__1) 
			    + ddot(&i__4, &c__[k2 + c_dim1], ldc, &a[l1 * 
			    a_dim1 + 1], &c__1));

		    d__1 = -a[l1 + l1 * a_dim1];
		    dlaln2(&c_true, &c__2, &c__1, &smin, &c_b25, &a[k1 + k1 *
...
/* L20: */
			...
			*scale *= scaloc;
		    ...
		    i__3 = k1 - 1;
		    i__4 = l1 - 1;
		    vec[1] = c__[k1 + l2 * c_dim1] - (ddot(&i__3, &a[k1 * 
			    a_dim1 + 1], &c__1, &c__[l2 * c_dim1 + 1], &c__1) 
			    + ddot(&i__4, &c__[k1 + c_dim1], ldc, &a[l2 * 
			    a_dim1 + 1], &c__1));

		    d__1 = -a[k1 + k1 * a_dim1];
		    dlaln2(&c_true, &c__2, &c__1, &smin, &c_b25, &a[l1 + l1 *
			     a_dim1], lda, &c_b25, &c_b25, vec, &c__2, &d__1, 
			    &c_b29, x, &c__2, &scaloc, &xnorm, &ierr);
		    if (ierr != 0) {
			*info = 1;
...
/* L30: */
			...
			*scale *= scaloc;
		    ...
		    i__3 = k1 - 1;
		    i__4 = l1 - 1;
		    vec[2] = c__[k1 + l2 * c_dim1] - (ddot(&i__3, &a[k1 * 
			    a_dim1 + 1], &c__1, &c__[l2 * c_dim1 + 1], &c__1) 
			    + ddot(&i__4, &c__[k1 + c_dim1], ldc, &a[l2 * 
			    a_dim1 + 1], &c__1));
		    ...
		    i__3 = k1 - 1;
		    i__4 = l1 - 1;
		    vec[3] = c__[k2 + l2 * c_dim1] - (ddot(&i__3, &a[k2 * 
			    a_dim1 + 1], &c__1, &c__[l2 * c_dim1 + 1], &c__1) 
			    + ddot(&i__4, &c__[k2 + c_dim1], ldc, &a[l2 * 
			    a_dim1 + 1], &c__1));

		    if (k1 == l1) {
			sb03mw(&c_false, &lupper, &a[k1 + k1 * a_dim1], lda, 
			...
			dlasy2(&c_true, &c_false, &c__1, &c__2, &c__2, &a[k1 
...
/* Computing MIN */
		...
		if (l1 == l2 && k1 == k2) {
		    i__1 = *n - k1;
		    i__2 = *n - l1;
		    vec[0] = c__[k1 + l1 * c_dim1] - (ddot(&i__1, &a[k1 + 
			    mink1n * a_dim1], lda, &c__[mink1n + l1 * c_dim1],
			     &c__1) + ddot(&i__2, &c__[k1 + minl1n * c_dim1],
			...
			*scale *= scaloc;
		    ...
		    vec[0] = c__[k1 + l1 * c_dim1] - (ddot(&i__1, &a[k1 + 
			    mink2n * a_dim1], lda, &c__[mink2n + l1 * c_dim1],
			     &c__1) + ddot(&i__2, &c__[k1 + minl2n * c_dim1],
			     ldc, &a[l1 + minl2n * a_dim1], lda));

		    i__1 = *n - k2;
		    i__2 = *n - l2;
		    vec[1] = c__[k2 + l1 * c_dim1] - (ddot(&i__1, &a[k2 + 
			    mink2n * a_dim1], lda, &c__[mink2n + l1 * c_dim1],
			     &c__1) + ddot(&i__2, &c__[k2 + minl2n * c_dim1],
			     ldc, &a[l1 + minl2n * a_dim1], lda));

		    d__1 = -a[l1 + l1 * a_dim1];
		    dlaln2(&c_false, &c__2, &c__1, &smin, &c_b25, &a[k1 + k1 
			    * a_dim1], lda, &c_b25, &c_b25, vec, &c__2, &d__1,
			     &c_b29, x, &c__2, &scaloc, &xnorm, &ierr);
		    if (ierr != 0) {
			*info = 1;
...
/* L80: */
			...
			*scale *= scaloc;
		    ...
		    i__1 = *n - k1;
		    i__2 = *n - l2;
		    vec[1] = c__[k1 + l2 * c_dim1] - (ddot(&i__1, &a[k1 + 
			    mink1n * a_dim1], lda, &c__[mink1n + l2 * c_dim1],
			     &c__1) + ddot(&i__2, &c__[k1 + minl2n * c_dim1],
			     ldc, &a[l2 + minl2n * a_dim1], lda));

		    d__1 = -a[k1 + k1 * a_dim1];
		    dlaln2(&c_false, &c__2, &c__1, &smin, &c_b25, &a[l1 + l1 
			    * a_dim1], lda, &c_b25, &c_b25, vec, &c__2, &d__1,
			     &c_b29, x, &c__2, &scaloc, &xnorm, &ierr);
		    if (ierr != 0) {
			*info = 1;
...
/* L90: */
			...
			*scale *= scaloc;
		    ...
		    i__1 = *n - k2;
		    i__2 = *n - l2;
		    vec[2] = c__[k1 + l2 * c_dim1] - (ddot(&i__1, &a[k1 + 
		    ...
		    i__1 = *n - k2;
		    i__2 = *n - l2;
		    vec[3] = c__[k2 + l2 * c_dim1] - (ddot(&i__1, &a[k2 + 
			    mink2n * a_dim1], lda, &c__[mink2n + l2 * c_dim1],
			     &c__1) + ddot(&i__2, &c__[k2 + minl2n * c_dim1],
			     ldc, &a[l2 + minl2n * a_dim1], lda));

		    if (k1 == l1) {
			sb03mw(&c_true, &lupper, &a[k1 + k1 * a_dim1], lda, 
				vec, &c__2, &scaloc, x, &c__2, &xnorm, &ierr);
			if (lupper) {
			    x[1] = x[2];
			} else {
			...
			dlasy2(&c_false, &c_true, &c__1, &c__2, &c__2, &a[k1 
				+ k1 * a_dim1], lda, &a[l1 + l1 * a_dim1], 
				lda, vec, &c__2, &scaloc, x, &c__2, &xnorm, &
				ierr);
		    }
