/* MB04OY.f -- translated by f2c (version 20041007).
...
/* Subroutine */ int mb04oy(integer *m, integer *n, doublereal *v, 
...
/*     w := C'*u,  C := C - tau * u * w'. */
    ...
    dcopy(n, &a[a_offset], lda, &dwork[1], &c__1);
    dgemv("Transpose", m, n, &c_b14, &b[b_offset], ldb, &v[1], &c__1, &c_b14,
	     &dwork[1], &c__1);
    d__1 = -(*tau);
    daxpy(n, &d__1, &dwork[1], &c__1, &a[a_offset], lda);
    d__1 = -(*tau);
    dger(m, n, &d__1, &v[1], &c__1, &dwork[1], &c__1, &b[b_offset], ldb);
    goto L210;
L10:
