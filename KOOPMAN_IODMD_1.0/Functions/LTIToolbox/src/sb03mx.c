/* SB03MX.f -- translated by f2c (version 20041007).
...
/* Subroutine */ int sb03mx(char *trana, integer *n, doublereal *a, integer *
...
/* Computing MAX */
    d__1 = smlnum, d__2 = eps * dlanhs("Max", n, &a[a_offset], lda, &dwork[1]
	    );
    smin = max(d__1,d__2);
    np1 = *n + 1;
...
/*           K1 (K2): row index of the first (last) row of X(K,L). */
	    ...
	    dwork[*n + l1] = 0.;
	    i__2 = l1 - 1;
	    dsymv("Lower", &i__2, &c_b11, &c__[c_offset], ldc, &a[l1 * 
		    a_dim1 + 1], &c__1, &c_b13, &dwork[1], &c__1);
	    i__2 = l1 - 1;
	    dsymv("Lower", &i__2, &c_b11, &c__[c_offset], ldc, &a[l2 * 
		    a_dim1 + 1], &c__1, &c_b13, &dwork[np1], &c__1)
		    ;
		...
		if (l1 == l2 && k1 == k2) {
		    i__3 = l1 - 1;
		    dwork[k1] = ddot(&i__3, &c__[k1 + c_dim1], ldc, &a[l1 * 
			    a_dim1 + 1], &c__1);

		    i__3 = k1 - 1;
		    vec[0] = c__[k1 + l1 * c_dim1] - (ddot(&k1, &a[k1 * 
			    a_dim1 + 1], &c__1, &dwork[1], &c__1) + a[l1 + l1 
			    * a_dim1] * ddot(&i__3, &a[k1 * a_dim1 + 1], &
			...
			*info = 1;
			...
			i__3 = *n;
			for (j = 1; j <= i__3; ++j) {
			    dscal(n, &scaloc, &c__[j * c_dim1 + 1], &c__1);
/* L10: */
			}

			dscal(n, &scaloc, &dwork[1], &c__1);
			*scale *= scaloc;
		    }
		    ...
		    dwork[k1] = ddot(&i__3, &c__[k1 + c_dim1], ldc, &a[l1 * 
			    a_dim1 + 1], &c__1);
		    i__3 = l1 - 1;
		    dwork[k2] = ddot(&i__3, &c__[k2 + c_dim1], ldc, &a[l1 * 
			    a_dim1 + 1], &c__1);

		    i__3 = k1 - 1;
		    vec[0] = c__[k1 + l1 * c_dim1] - (ddot(&k2, &a[k1 * 
			    a_dim1 + 1], &c__1, &dwork[1], &c__1) + a[l1 + l1 
			    * a_dim1] * ddot(&i__3, &a[k1 * a_dim1 + 1], &
			    c__1, &c__[l1 * c_dim1 + 1], &c__1));

		    i__3 = k1 - 1;
		    vec[1] = c__[k2 + l1 * c_dim1] - (ddot(&k2, &a[k2 * 
			    a_dim1 + 1], &c__1, &dwork[1], &c__1) + a[l1 + l1 
			    * a_dim1] * ddot(&i__3, &a[k2 * a_dim1 + 1], &
			    c__1, &c__[l1 * c_dim1 + 1], &c__1));

		    dlaln2(&c_true, &c__2, &c__1, &smin, &a[l1 + l1 * a_dim1]
...
/* L20: */
			...
			*scale *= scaloc;
		    ...
		    dwork[k1] = ddot(&i__3, &c__[k1 + c_dim1], ldc, &a[l1 * 
			    a_dim1 + 1], &c__1);
		    i__3 = l1 - 1;
		    dwork[*n + k1] = ddot(&i__3, &c__[k1 + c_dim1], ldc, &a[
			    l2 * a_dim1 + 1], &c__1);
		    i__3 = k1 - 1;
		    p11 = ddot(&i__3, &a[k1 * a_dim1 + 1], &c__1, &c__[l1 * 
			    c_dim1 + 1], &c__1);
		    i__3 = k1 - 1;
		    p12 = ddot(&i__3, &a[k1 * a_dim1 + 1], &c__1, &c__[l2 * 
			    c_dim1 + 1], &c__1);
		    ...
		    vec[1] = c__[k1 + l2 * c_dim1] - (ddot(&k1, &a[k1 * 
			    a_dim1 + 1], &c__1, &dwork[np1], &c__1) + p11 * a[
			    l1 + l2 * a_dim1] + p12 * a[l2 + l2 * a_dim1]);

		    dlaln2(&c_true, &c__2, &c__1, &smin, &a[k1 + k1 * a_dim1]
...
/* L30: */
			...
			*scale *= scaloc;
		    ...
		    dwork[*n + k1] = ddot(&i__3, &c__[k1 + c_dim1], ldc, &a[
			    l2 * a_dim1 + 1], &c__1);
		    i__3 = l1 - 1;
		    dwork[*n + k2] = ddot(&i__3, &c__[k2 + c_dim1], ldc, &a[
			    l2 * a_dim1 + 1], &c__1);
		    i__3 = k1 - 1;
		    p11 = ddot(&i__3, &a[k1 * a_dim1 + 1], &c__1, &c__[l1 * 
			    c_dim1 + 1], &c__1);
		    ...
		    p12 = ddot(&i__3, &a[k1 * a_dim1 + 1], &c__1, &c__[l2 * 
			    c_dim1 + 1], &c__1);
		    i__3 = k1 - 1;
		    p21 = ddot(&i__3, &a[k2 * a_dim1 + 1], &c__1, &c__[l1 * 
			    c_dim1 + 1], &c__1);
		    i__3 = k1 - 1;
		    p22 = ddot(&i__3, &a[k2 * a_dim1 + 1], &c__1, &c__[l2 * 
			    c_dim1 + 1], &c__1);
		    ...
		    vec[2] = c__[k1 + l2 * c_dim1] - (ddot(&k2, &a[k1 * 
			    a_dim1 + 1], &c__1, &dwork[np1], &c__1) + p11 * a[
			    l1 + l2 * a_dim1] + p12 * a[l2 + l2 * a_dim1]);
		    ...
		    vec[3] = c__[k2 + l2 * c_dim1] - (ddot(&k2, &a[k2 * 
			    a_dim1 + 1], &c__1, &dwork[np1], &c__1) + p21 * a[
			    l1 + l2 * a_dim1] + p22 * a[l2 + l2 * a_dim1]);

		    if (k1 == l1) {
			sb03mv(&c_false, &lupper, &a[k1 + k1 * a_dim1], lda, 
			...
			sb04px(&c_true, &c_false, &c_n1, &c__2, &c__2, &a[k1 
...
/*           K1 (K2): row index of the first (last) row of X(K,L) */
	    ...
	    if (l2 < *n) {
		i__1 = *n - l2;
		dsymv("Upper", &i__1, &c_b11, &c__[l2 + 1 + (l2 + 1) * 
...
/* Computing MIN */
		...
		if (l1 == l2 && k1 == k2) {
		    i__1 = *n - l1;
		    dwork[k1] = ddot(&i__1, &c__[k1 + minl1n * c_dim1], ldc, 
			    &a[l1 + minl1n * a_dim1], lda);

		    i__1 = *n - k1 + 1;
		    i__2 = *n - k1;
		    vec[0] = c__[k1 + l1 * c_dim1] - (ddot(&i__1, &a[k1 + k1 
			    * a_dim1], lda, &dwork[k1], &c__1) + ddot(&i__2, 
...
/* L70: */
			...
			*scale *= scaloc;
		    ...
		    dwork[k1] = ddot(&i__1, &c__[k1 + minl1n * c_dim1], ldc, 
			    &a[l1 + minl1n * a_dim1], lda);
		    i__1 = *n - l1;
		    dwork[k2] = ddot(&i__1, &c__[k2 + minl1n * c_dim1], ldc, 
			    &a[l1 + minl1n * a_dim1], lda);
		    ...
		    i__1 = np1 - k1;
		    i__2 = *n - k2;
		    vec[1] = c__[k2 + l1 * c_dim1] - (ddot(&i__1, &a[k2 + k1 
			    * a_dim1], lda, &dwork[k1], &c__1) + ddot(&i__2, 
			    &a[k2 + mink2n * a_dim1], lda, &c__[mink2n + l1 * 
			    c_dim1], &c__1) * a[l1 + l1 * a_dim1]);

		    dlaln2(&c_false, &c__2, &c__1, &smin, &a[l1 + l1 * 
...
/* L80: */
			...
			*scale *= scaloc;
		    ...
		    i__1 = *n - l2;
		    dwork[k1] = ddot(&i__1, &c__[k1 + minl2n * c_dim1], ldc, 
			    &a[l1 + minl2n * a_dim1], lda);
		    i__1 = *n - l2;
		    dwork[*n + k1] = ddot(&i__1, &c__[k1 + minl2n * c_dim1], 
			    ldc, &a[l2 + minl2n * a_dim1], lda);
		    i__1 = *n - k1;
		    p11 = ddot(&i__1, &a[k1 + mink1n * a_dim1], lda, &c__[
			    mink1n + l1 * c_dim1], &c__1);
		    i__1 = *n - k1;
		    p12 = ddot(&i__1, &a[k1 + mink1n * a_dim1], lda, &c__[
		    ...
		    i__1 = np1 - k1;
		    vec[1] = c__[k1 + l2 * c_dim1] - (ddot(&i__1, &a[k1 + k1 
			    * a_dim1], lda, &dwork[*n + k1], &c__1) + p11 * a[
			    l2 + l1 * a_dim1] + p12 * a[l2 + l2 * a_dim1]);

		    dlaln2(&c_false, &c__2, &c__1, &smin, &a[k1 + k1 * 
...
/* L90: */
			...
			*scale *= scaloc;
		    ...
		    dwork[k1] = ddot(&i__1, &c__[k1 + minl2n * c_dim1], ldc, 
			    &a[l1 + minl2n * a_dim1], lda);
		    i__1 = *n - l2;
		    dwork[k2] = ddot(&i__1, &c__[k2 + minl2n * c_dim1], ldc, 
			    &a[l1 + minl2n * a_dim1], lda);
		    i__1 = *n - l2;
		    dwork[*n + k1] = ddot(&i__1, &c__[k1 + minl2n * c_dim1], 
			    ldc, &a[l2 + minl2n * a_dim1], lda);
		    i__1 = *n - l2;
		    dwork[*n + k2] = ddot(&i__1, &c__[k2 + minl2n * c_dim1], 
			    ldc, &a[l2 + minl2n * a_dim1], lda);
		    i__1 = *n - k2;
		    p11 = ddot(&i__1, &a[k1 + mink2n * a_dim1], lda, &c__[
			    mink2n + l1 * c_dim1], &c__1);
		    i__1 = *n - k2;
		    p12 = ddot(&i__1, &a[k1 + mink2n * a_dim1], lda, &c__[
			    mink2n + l2 * c_dim1], &c__1);
		    i__1 = *n - k2;
		    p21 = ddot(&i__1, &a[k2 + mink2n * a_dim1], lda, &c__[
			    mink2n + l1 * c_dim1], &c__1);
		    i__1 = *n - k2;
		    p22 = ddot(&i__1, &a[k2 + mink2n * a_dim1], lda, &c__[
			    mink2n + l2 * c_dim1], &c__1);
		    ...
		    i__1 = np1 - k1;
		    vec[2] = c__[k1 + l2 * c_dim1] - (ddot(&i__1, &a[k1 + k1 
			    * a_dim1], lda, &dwork[*n + k1], &c__1) + p11 * a[
			    l2 + l1 * a_dim1] + p12 * a[l2 + l2 * a_dim1]);
		    ...
		    i__1 = np1 - k1;
		    vec[3] = c__[k2 + l2 * c_dim1] - (ddot(&i__1, &a[k2 + k1 
			    * a_dim1], lda, &dwork[*n + k1], &c__1) + p21 * a[
			    l2 + l1 * a_dim1] + p22 * a[l2 + l2 * a_dim1]);

		    if (k1 == l1) {
			sb03mv(&c_true, &lupper, &a[k1 + k1 * a_dim1], lda, 
				vec, &c__2, &scaloc, x, &c__2, &xnorm, &ierr);
			if (lupper) {
			    x[1] = x[2];
			} else {
			...
			sb04px(&c_false, &c_true, &c_n1, &c__2, &c__2, &a[k1 
				+ k1 * a_dim1], lda, &a[l1 + l1 * a_dim1], 
				lda, vec, &c__2, &scaloc, x, &c__2, &xnorm, &
				ierr);
		    }
