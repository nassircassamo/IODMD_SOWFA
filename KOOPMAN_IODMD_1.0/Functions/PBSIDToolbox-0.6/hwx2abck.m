function [A,B,C,K] = hwx2abck(x,u,y,f,p,c)
%HWX2ABCK Estimates the matrices A, B, C and D of the state space model
%  [A,B,C] = hwx2abck(x,fu,g1y,f,p) estimates the matrices A, B, and C
...
%
%  [A,B,C] = hwx2abck(x,fu,g1y,f,p,'stable') estimates a stable matrix A
%  by using the method in [1].
%
%  [A,B,C,K] = hwx2abck(x,fu,g1y,f,p) returns a Kalman matrix K
%  calculated by the discrete Riccati equation, which gives a guaranteed
%  stable A-KC (predictor from).
%
%  See also: hwmodx.m, hwordvarx.m, hwx2abcdk.m.
%
%  References:
