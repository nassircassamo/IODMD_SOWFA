function inov = abcdk2idss(data,A,B,C,D,K)
%ABCDK2IDSS Create IDSS model structure
%  M = ABCDK2IDSS(IDDATA,A,B,C,D,K) returnes as a model structure object
...
inov = idss(A,B,C,D,K,zeros(n,1),Ts,'InputName',data.Inputname,...
    'OutputName',data.Outputname,'DisturbanceModel','Estimate',...
